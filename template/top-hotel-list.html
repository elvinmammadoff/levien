                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="Banner__info">
                            <h2 class="Banner__title">
                                Top <span class="Banner__label">casino hotels</span> in Europe
                            </h2>
                            <p class="Banner__description">
                                If you enjoy <span class="bold">gambling</span> , why not stay where you can play?<br>
                                Choose the <span class="bold">casino hotels</span> that suit you best on the list.
                            </p>
                        </div>
                    </div>
