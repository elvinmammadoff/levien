...
<svg aria-hidden="true" style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
        ...
        <symbol id="icon-close" viewBox="0 0 32 32">
            <title>close</title>
            <path d="M18.314 16l13.686 13.686-2.315 2.314-13.685-13.686-13.686 13.686-2.314-2.314 13.685-13.686-13.685-13.686 2.314-2.314 13.686 13.686 13.685-13.686 2.315 2.314z"></path>
        </symbol><!-- End Close Icon -->

        <!-- Start Pin Sharp Circle Icon -->
        <symbol id="icon-pin_sharp_circle" viewBox="0 0 22 32">
            <title>pin_sharp_circle</title>
            <path d="M14.4 11.55c0 1.768-1.432 3.2-3.2 3.2s-3.2-1.432-3.2-3.2c0-1.768 1.432-3.2 3.2-3.2s3.2 1.432 3.2 3.2zM11.2 27.2c0 0-8-11.2-8-16 0-4.411 3.589-8 8-8s8 3.589 8 8c0 4.8-8 16-8 16zM11.2 0c-6.186 0-11.2 5.014-11.2 11.2s11.2 20.8 11.2 20.8c0 0 11.2-14.614 11.2-20.8s-5.014-11.2-11.2-11.2z"></path>
        </symbol><!-- End Pin Sharp Circle Icon -->
        
        <!-- Start Checked Icon -->
        <symbol id="icon-checked" viewBox="0 0 32 32">
            <title>checked</title>
            <path d="M16 28.8c-7.069 0-12.8-5.731-12.8-12.8v0c0-7.069 5.731-12.8 12.8-12.8v0c7.069 0 12.8 5.731 12.8 12.8v0c0 7.069-5.731 12.8-12.8 12.8v0zM16 32v0c8.837 0 16-7.163 16-16v0c0-8.837-7.163-16-16-16v0c-8.837 0-16 7.163-16 16v0c0 8.837 7.163 16 16 16zM14.523 20.8l7.877-7.68-1.969-1.92-5.908 5.761-2.955-2.881-1.969 1.92 4.923 4.801z"></path>
        </symbol><!-- End Checked Icon -->
...
<ul class="Menu Menu--line">
    ...
    <!-- Start .Menu-item -->
    <!-- <li class="Menu-item">
        <a href="/about.html" title="Что мы делаем?" class="Menu-item__link">
        Что мы делаем?
        </a>
    </li> -->
    <!-- End /.Menu-item--> 
...
<div class="Banner__info">
    ...
    <h2 class="Banner__title">
        Вы можете получить подробную <span class="Banner__label">информацию</span> об этом  поговорив нами
    </h2><!-- End /.Banner__title -->

    <!-- Start .Banner__description -->
    <p class="Banner__description">
        Здесь вы <span class="semibold">можете</span> найти отзывы экспертов о лучших отелях казино в <span class="semibold">Европе</span> для вас. Выберите отели казино.
    </p><!-- End /.Banner__description -->

    <a href="hotel.html" class="button button--large" title="более">КОНСУЛЬТАЦИЯ ЗАПРОСОВ</a>

</div><!-- End /.Banner__info -->
...
<div class="stars">
    ...
    </div><!-- End /.Banner-card__header -->

    <!-- Start .Banner-card__body -->
    <div class="Banner-card__body">
        <div class="title--gray">АДРЕС:</div> 
        <p class="Hotels__description">3 Avenue Georges Bassinet, 69260 Charbonnières-les-Bains, Frankrike</p>
    </div><!-- End /.Banner-card__body --> 
...
<!-- Start .button -->
<button class="button button--block button--border button--icon" data-toggle="modal" data-target="#exampleModalCenter">ПОКАЗАТЬ АДРЕС
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        ...
        <div class="modal-header">
            <h3 class="modal-title" id="exampleModalCenterTitle"><strong>Ритц Лондон</strong> 3 Avenue Georges Bassinet, 69260 Charbonnières-les-Bains, Frankrike</h3>
        ...
        <div class="modal-body">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d42555.27704370547!2d4.738953456567812!3d45.785677388527326!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47f4ed3dfa0b3be3%3A0x125fc5b76f2bc0a6!2s3+Avenue+Georges+Bassinet%2C+69260+Charbonni%C3%A8res-les-Bains%2C+France!5e0!3m2!1sen!2s!4v1537101762318" width="1110" height="570" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
        </div>
    </div>
</div><!-- End /.modal -->   
...
<section class="Hotel-card section clearfix">
    ...
    <div class="Hotel-header__title">
        ...
        <p class="text">
            Здесь вы можете найти отзывы экспертов о лучших отелях казино в Европе для вас. Выберите отели казино, которые подходят вам лучше всего в списке.            
        </p>
    </div>
</div> 
...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="text">
        <p>
            В казино-казино Motor Lodge предоставляются бесплатные услуги wi-fi. Сам отель находится в 10 минутах ходьбы от казино Крайстчерча. 
            В некоторых номерах есть гидромассажная ванна. В каждом номере есть электрические одеяла, спутниковое телевидение. 
            Каждое утро гостям предлагаются два завтрака.
        </p>
        <p>
            Казино Крайстчерча расположено в районе Виктории-стрит, лучшем развлекательном центре города. 
            В казино Крайстчерча 36 настольных игр и 500 игровых автоматов всегда готовы для наших клиентов. 
            Находится недалеко от казино Крайстчерча. На автостоянке Peterborough Street есть 266 парковочных мест. 
            Кроме того, есть шанс выиграть бесплатную ежедневную парковку. Стоимость автостоянки составляет 3 $ в час до 12 $ в день.
        </p>
        <p>
            Для получения дополнительной информации, пожалуйста, свяжитесь с Даррен Хендерсон для получения информации о парковке (03) 372 8892. 
            Чтобы обеспечить мирную, безопасную и зрелую атмосферу, где клиенты наслаждаются своим развлечением, без перерывов с другими, 
            ненадлежащим образом одетыми или действуя грубо, мы применяем R20 & Dress Code - умный и аккуратный стандарт внешнего вида является обязательным.
        </p>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 valign">
                        <p class="Hotels__description">150 Piccadilly, St James, London W1J 9BR, Storbritannien</p>
                    </div>                                                                        
                </div>
            </div>
...
<form action="" method="" class="Form">
    ...
    <div class="Form__group Form__group--one">
        <input type="email" class="Form__input Form__input--group" id="email" name="email" spellcheck="false" autocapitalize="off" required>
        <label for="email" class="Form__label Form__label--group">Электронная почта</label>
        <span class="Form__send">        
            <input type="submit" value="" class="Form__submit" data-toggle="modal" data-target="#exampleModalCenter">          
        </span>
    </div><!-- End /.Form__group -->    
