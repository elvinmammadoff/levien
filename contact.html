...
<section class="Contact-info">
    <div class="container">
        ...
        <div class="text">
            <p>
                Мы считаем, что двусторонняя связь является лучшей и поэтому мы сообщаем нашу <span class="semibold">контактную</span> информацию, 
            ...
            <p>
                ...
                Ваши <span class="semibold">отзывы</span> помогают нам не только расти в нашей отрасли, но и в конечном итоге привлекать постоянных 
                <span class="semibold">клиентов</span>. 
                Поэтому мы с нетерпением ожидаем услышать от вас, а не только о том, что мы делаем неправильно, 
...
<div class="Contact__form">
    ...
    <!-- Start .Contact-card -->
    <form action="" method="POST" class="d-flex justify-content-between flex-wrap Contact-card card card--padd" autocomplete="off" >

        <h2 class="title title--mini">Отправьте нам <span class="semibold title__label">сообщение</span></h2>       
        ...
        <div class="Form Form--row">
            ...
            <!-- Start .Form__group -->
            <div class="Form__group Form__group--half">
                <input type="text" class="Form__input" id="surname" spellcheck="false" autocapitalize="off" required>
            ...
            <!-- Start .Form__group -->
            <div class="Form__group">
                <textarea rows="5" id="message" class="Form__input Form__input--textarea resize" spellcheck="false" autocapitalize="off" required></textarea>
                <label for="message" class="Form__label">Сообщение</label>
            </div><!-- End /.Form__group -->
            
            <!-- Start .Form__group -->
            <div class="Form__group align">
                <input type="submit" value="ОТПРАВИТЬ СООБЩЕНИЕ" class="button button--medium" data-toggle="modal" data-target="#exampleModalCenter1">
            </div><!-- End /.Form__group -->
            
        </div><!-- End /.Form -->
        
    </form><!-- End /.Contact-card -->   
